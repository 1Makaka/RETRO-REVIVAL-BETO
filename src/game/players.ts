...
export const HEROES: Record<string, HeroData> = {
  ...
  char_bjorn: {
    ...
    skills: [
      {
        name: 'Землетрясение (Навык 1)',
        icon: 'skill_bjorn_1',
        cooldown: 3.2,
        desc: 'Бьет ногой о землю, вызывая цепь каменных шипов прямо перед собой.'
      },
      {
        name: 'Мощный таран (Навык 2)',
        icon: 'skill_bjorn_2',
        cooldown: 4.5,
        desc: 'Делает сокрушительный рывок плечом, отбрасывая противников.'
      },
      {
        name: 'Вихрь топоров (УЛЬТА)',
        icon: 'skill_bjorn_3',
        cooldown: 12.0,
        desc: 'Бешено вращается с тяжелым топором, нанося АОЕ урон (массовый урон по площади) вокруг себя.'
      }
    ]
  }
};
